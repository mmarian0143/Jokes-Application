    ...
    <body>    
        <form class="form-horizontal" action="process_new_user.php" method = "get">        
            ...
            <div class="form-group">            
                <label class="col-md-4 control-label" for="keyword">New username</label>          <div class="col-md-5">                
            ...
            <div class="form-group">            
                <label class="col-md-4 control-label" for="keyword">New password</label>          <div class="col-md-5">                
                    <input id = "password" type="password" name="password1" placeholder="" class="form-control input-md" required="">                
            ...
            <div class="form-group">            
                ...
                <div class="col-md-5">                
                    <input id = "password-confirm" type="password" name="password2" placeholder="" class="form-control input-md" required="">                
            ...
            <div class="form-group">            
                ...
                <div class="col-md-4">            
                    <button id="submit" name="submit" class="btn btn-primary">OK</button>        </div>        
                </div>    
            </form>
        </body>
        </html> 